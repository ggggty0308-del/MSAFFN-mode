...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        dataset_dir='F:/pycharm/self/seld-dcase2021/dateset',

        # OUTPUT PATHS
         # Directory to dump extracted features and labels
        feat_label_dir='F:/pycharm/self/seld-dcase2021/feat_label1',
 
        model_dir='F:/pycharm/self/seld-dcase2021/models',  # Dumps the trained models and training curves in this folder
        dcase_output_dir='F:/pycharm/self/seld-dcase2021/results',    # recording-wise results are dumped in this path.
