...
def acs(data_dir, aug_dir):
	...
	for sub_folder in os.listdir(data_dir):
		...
		loc_desc_folder = os.path.join(data_dir, sub_folder) #原音频
		loc_aug_folder = os.path.join(aug_dir, sub_folder + "-aug-acs")#增强后的音频
...
def rand_sample(base_dir, subset_dir):
	...
	src_path = os.path.join(base_dir, "foa_dev")
	...
	for folder in os.listdir(src_path):
			...
			src_foa = os.path.join(src_path, folder)
			...
			filenames = random.sample(os.listdir(src_foa), round(len(os.listdir(src_foa)) * 0.125))
...
if __name__ == "__main__":
	...
	base_dir = "G:/seld-dcase2021-main/dateset-aug/"
	aug_dir = "G:/seld-dcase2021-main/dateset-aug/"
	#subset_dir = "F:/pycharm/self2/seld-dcase2023-main/dateset/subset"
